...
const { EMAIL, MAILING_ID, MAILING_SECRET, MAILING_REFEESH } = process.env;
...
const sentVerificationEmail = (email, name, url) => {
  auth.setCredentials({
    refresh_token: MAILING_REFEESH,
  });
